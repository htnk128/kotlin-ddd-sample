package htnk128.kotlin.spring.boot.ddd.sample.contactdetails.infrastructure.persistence
...
private fun ResultRow.rowToModel() =
    ContactDetails(
        ContactDetailsIdentity(
            this[ContactDetailsTable.contactDetailsId]
        ),
        CustomerIdentity(
            this[ContactDetailsTable.customerId]
        ),
        TelephoneNumber(
            this[ContactDetailsTable.telephoneNumber]
        )
    )
