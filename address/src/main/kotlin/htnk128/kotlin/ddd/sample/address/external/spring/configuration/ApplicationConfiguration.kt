package htnk128.kotlin.ddd.sample.address.external.spring.configuration
...
class SpringfoxConfiguration {
    ...
    fun customDocket(): Docket = Docket(DocumentationType.SWAGGER_2)
        .select()
        .apis(RequestHandlerSelectors.basePackage("htnk128.kotlin.ddd.sample.address.external.spring.rest"))
        .build()
